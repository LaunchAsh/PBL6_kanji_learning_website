...
function drawTopResult(top_k){
	result_ctx.clearRect(0, 0, result_ctx.canvas.width, result_ctx.canvas.height);
	var top_1_character = top_k[0]['className']
	...
	result_ctx.fillText(top_1_character, 10, 143);
	result_ctx.fillText(top_2_character, 80, 143);
	result_ctx.fillText(top_3_character, 150, 143);
	result_ctx.fillText(top_4_character, 220, 143);
	result_ctx.fillText(top_5_character, 290, 143);
}
